        ...
        <div class="col-md-12">
            ...
            <form method='post' action='searchCourseStudent' class="rounded position-relative">@csrf
                <div class="search-container">
                    <input required id="search-input" class="form-control bg-body" name='search' placeholder='Search for course, course code, and description in 10,000+ courses' type="search" placeholder="Search" aria-label="Search">
                    <ul id="suggestions"></ul>
                </div>
                <button class="btn bg-transparent px-2 py-0 position-absolute top-50 end-0 translate-middle-y" type="submit"><a class='btn btn-sm btn-success'><i class="fas fa-search fs-6 "></i>Search</a></button>
            </form>
        </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card shadow h-100">
                        ...
                        <div class="card-footer pt-0 pb-3">
                            ...
                            <span class='btn btn-secondary btn-sm'>Already Enrolled</span>
                            @else
                            <a href='/confirm_enroll/{{ $course->uid }}' class='btn btn-success btn-sm'>Enroll Now</a>
                            @endif
                            @else
